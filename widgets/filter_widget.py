...
class FilterWidget(QWidget):
    ...
    def __init__(self, node_id, msg_id, on_toggle, on_delete, parent=None):
        ...
        self.btn_visible.setStyleSheet("QPushButton { background-color: #4CAF50; color:black; font-size: 10px; font-weight: bold; }")
        ...
        self.btn_delete.setStyleSheet("QPushButton { background-color: #f44336; color: black; font-weight: bold; }")
    ...
    def toggle_active(self):
        ...
        if self.is_active:
            ...
            self.btn_visible.setStyleSheet("QPushButton { background-color: #757575; color: black; font-size: 10px; font-weight: bold; }")
